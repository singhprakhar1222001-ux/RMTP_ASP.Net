...
namespace SearchService.API.Features.AddIndex
{
    ...
    public class WorkIndexCommandHandler : IRequestHandler<WorkIndexCommand>
    {
        ...
        public async Task Handle(WorkIndexCommand request, CancellationToken cancellationToken)
        {
